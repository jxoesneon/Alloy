...
describe("organisms", () => {
  ...
  it("renders KPIBoard", () => {
    const { container } = render(
      React.createElement(KPIBoard, { title: "KPI", aria: { label: "A" } }),
    );
  ...
  it("renders DataTable", () => {
    const { container } = render(
      React.createElement(DataTable, {
        columns: [{ key: "id", header: "ID", isSortable: false }],
        rows: [{ id: "1" }],
        caption: "Cap",
        aria: { label: "table" },
      }),
  ...
  it("renders ProfileHeader default", () => {
    const { container } = render(
      React.createElement(ProfileHeader, { name: "Name2" }),
    );
  ...
  it("renders FormGroup", () => {
    const { container } = render(
      React.createElement(FormGroup, { title: "Form", aria: { label: "A" } }),
    );
  ...
  it("renders StatusBanner default", () => {
    const { container } = render(
      React.createElement(StatusBanner, { message: "Msg2" }),
    );
  ...
  it("renders Modal invisible", () => {
    const { container } = render(
      React.createElement(Modal, { isVisible: false, title: "Modal" }),
    );
  ...
  it("renders Modal default content", () => {
    const { container } = render(
      React.createElement(Modal, { isVisible: true, title: "Modal2" }),
    );
